...
namespace CsharpContents.Collections.Dictionaries
{
    class Dictionary
    {
        ...
        public static void AddToDictionary(Dictionary<string, Element> elements,string symbol, string name, int atomicNumber)
        {
